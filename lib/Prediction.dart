...
class _PredictionState extends State<Prediction> {
  ...
  void initState() {
    super.initState();
    temperature.text = widget.temp.toStringAsFixed(1);
...
// Assuming TextsField is defined elsewhere, or it might need to be created.
class TextsField extends StatelessWidget {
  ...
  const TextsField(this.title, this.hint, this.controller, this.enabled);
